...
# set the WORDPRESS env vars from the first bound ClearDB Service
if [ -n "$VCAP_SERVICES_CLEARDB_0_NAME" ]; then
	WORDPRESS_DB_USER=${VCAP_SERVICES_CLEARDB_0_CREDENTIALS_USERNAME}
	WORDPRESS_DB_PASSWORD=${VCAP_SERVICES_CLEARDB_0_CREDENTIALS_PASSWORD}
	WORDPRESS_DB_HOST=${VCAP_SERVICES_CLEARDB_0_CREDENTIALS_HOSTNAME}:${VCAP_SERVICES_CLEARDB_0_CREDENTIALS_PORT}
...
EOPHP
		# Tells WordPress that updates should be installed via the "direct" method
